...
![](./httpsstatic001geekbangorgresourceimage4d4b4d79133fc4f8795e44ea3a48a7293a4b.png)

其中的“max user processes”就是一个进程能创建的最大线程数，我们可以修改这个参数：

![](./httpsstatic001geekbangorgresourceimage7377736fbbb5fadb35f9ae0cc47182938a77.png)

**3\. 参数`sys.kernel.threads-max`限制**。这个参数限制操作系统全局的线程数，通过下面的命令可以查看它的值。

![](./httpsstatic001geekbangorgresourceimage2e582e9f281f4f0d89be1983314713a70258.png)
...
![](./httpsstatic001geekbangorgresourceimage6fc26fe71c885aa0917d6aaf634cdb1b19c2.png)
...
![](./httpsstatic001geekbangorgresourceimaged23bd281cba5576304f0c1407aa16b01353b.png)
...
![](./httpsstatic001geekbangorgresourceimage5b4d5b64390e688a0f49c19b110106ee334d.png)
